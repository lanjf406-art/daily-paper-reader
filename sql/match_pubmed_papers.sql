-- ============================================================
-- PubMed table retrieval RPCs.
-- ============================================================

create or replace function match_pubmed_papers_exact(
...
create or replace function match_pubmed_papers_bm25(
  query_text text,
  match_count int,
  filter_published_start timestamptz default null,
  filter_published_end timestamptz default null
