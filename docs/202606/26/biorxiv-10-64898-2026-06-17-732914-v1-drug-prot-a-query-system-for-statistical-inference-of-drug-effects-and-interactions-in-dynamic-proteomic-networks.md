...
tldr: 药物效应与相互作用对联合疗法开发至关重要。Drug-Prot框架利用大规模扰动蛋白质组学数据，量化单药和组合药物的因果效应，并构建有向时间蛋白质依赖网络。在63种单药和59种组合作用于18个乳腺癌细胞系的数据上，通过交互式网页提供校正p值和网络结果，降低了多重检验负担。该工具将候选因果蛋白质特征与可操作的药物组合联系起来，助力精准治疗。
source: biorxiv
selection_source: fresh_fetch
motivation: 理解药物效应和药物-药物相互作用是开发联合疗法的关键，但目前缺乏从蛋白质组层面进行统计推断的系统。
method: 基于大规模扰动蛋白质组学数据，采用统计推断方法量化药物效应与相互作用，并重建有向时间蛋白质依赖网络。
result: 在63种单药和59种组合作用于18个乳腺癌细胞系的数据上，通过交互式网页提供校正p值、网络图和可下载结果。
conclusion: Drug-Prot将候选因果蛋白质特征与可操作药物组合联系起来，为联合疗法提供蛋白质组层面的决策支持。
---

## 摘要
理解药物效应和药物-药物相互作用对于开发联合疗法至关重要。我们提出了Drug-Prot，一个利用大规模扰动蛋白质组学来量化因果药物效应、药物-药物相互作用和动态蛋白质关系的计算框架。基于18种乳腺癌细胞系在6、24和48小时施用的63种单一药物和59种药物组合的数据，Drug-Prot估计药物对蛋白质表达的影响，并重建有向的时间蛋白质依赖性网络。

该公开可用的软件能够对用户定义的蛋白质集进行靶向分析，显著降低多重检验负担。通过交互式网页应用，用户可以获得单一药物和组合效应的校正p值、有向时间依赖性网络以及可下载的结果，而无需访问底层蛋白质组数据集。

作为用例，我们将不变性正则化随机森林应用于三阴性乳腺癌细胞系，以识别与药物反应相关的蛋白质。在Drug-Prot中查询这些蛋白质揭示了蛋白质网络层面的药物特异性和相互作用效应，展示了该框架如何将候选因果蛋白质特征与可行的药物组合联系起来。
